...
public class PostSocialServiceImpl implements PostSocialService {
    ...
    public PostSocialServiceImpl(PostMapper postMapper, UserMapper userMapper, PostLikeMapper likeMapper, PostCommentMapper commentMapper, NotifyService notifyService) {
