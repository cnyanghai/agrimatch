...
<template>
  <div class="milestone-list">
    ...
    <div v-else-if="milestones.length === 0" class="py-8 text-center">
      ...
      <p v-if="canAdd" class="text-xs text-neutral-400 mt-1">点击上方按钮添加履约节点</p>
    </div>
        ...
        <div class="bg-neutral-50 rounded-xl p-4 hover:bg-neutral-100/80 transition-colors">
          <div class="flex items-start justify-between gap-3">
            <div class="flex-1 min-w-0">
              ...
              <!-- 拒绝原因 -->
              <div v-if="milestone.status === 'rejected' && milestone.remark" class="mt-2 p-2 bg-error-50 rounded-lg">
