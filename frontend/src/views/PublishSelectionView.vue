...
<template>
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <!-- 发布供应 -->
      <div
        class="group relative bg-white rounded-2xl border-2 border-gray-100 p-8 hover:border-emerald-200 hover:shadow-xl transition-all cursor-pointer overflow-hidden"
        @click="goToPublishSupply"
      >
        <!-- 背景装饰 -->
        <div class="absolute top-0 right-0 w-32 h-32 bg-emerald-50 rounded-full -mr-16 -mt-16 opacity-50 group-hover:opacity-70 transition-opacity"></div>
        
        <div class="relative">
          <!-- 图标与标题 -->
          <div class="flex items-center gap-4 mb-6">
            <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
          ...
          <BaseButton
            type="primary"
            block
            class="group-hover:bg-emerald-700"
          >
            <span>立即发布供应</span>
      ...
      <!-- 发布采购 -->
      <div
        class="group relative bg-white rounded-2xl border-2 border-gray-100 p-8 hover:border-blue-200 hover:shadow-xl transition-all cursor-pointer overflow-hidden"
          ...
          <ul class="space-y-3 mb-6">
            ...
            >
              <div class="w-6 h-6 rounded-lg bg-blue-50 flex items-center justify-center shrink-0">
                <component :is="feature.icon" class="w-4 h-4 text-blue-600" />
              </div>
              <span>{{ feature.text }}</span>
            </li>
          </ul>
